 ...
 */
typedef struct {
	uint32_t tipo; // offset 0~3
	uint32_t usos; // offset 4~7
	uint64_t unused0; // Reservamos espacio offset 8~15
	uint64_t unused1; // Reservamos espacio offset 16~23
} texto_cualquiera_t; // size 24 bytes
...
typedef struct {
	uint32_t tipo; // offset 0~3
	uint32_t usos; // offset 4~7
	uint64_t tamanio; // offset 8~15
	const char* contenido; // offset 16~23
} texto_literal_t; // size 24 bytes
...
typedef struct {
	uint32_t tipo; // offset 0~3
	uint32_t usos; // offset 4~7
	texto_cualquiera_t* izquierda; // offset 8~15
	texto_cualquiera_t* derecha; // offset 16~23
} texto_concatenacion_t; // size 24 bytes
